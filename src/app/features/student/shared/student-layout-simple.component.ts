...
import { StudentSidebarSimpleComponent } from './student-sidebar-simple.component';

@Component({
  selector: 'app-student-layout-simple',
  imports: [CommonModule, RouterModule, RouterOutlet, StudentSidebarSimpleComponent],
  encapsulation: ViewEncapsulation.None,
  template: `
    <div class="min-h-screen bg-gray-100 flex">
      <!-- Sidebar -->
      <div class="hidden lg:flex lg:w-64 lg:flex-col">
        <app-student-sidebar-simple></app-student-sidebar-simple>
      </div>
